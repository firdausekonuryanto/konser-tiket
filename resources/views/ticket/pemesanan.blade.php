<x-app-layout>
                        ...
                        <table class="min-w-full table-auto border border-gray-300 dark:border-gray-700">
                            <thead class="bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-200">
                                <tr>
                                    ...
                                    <th class="px-4 py-2 border">Kode Ticket</th>
    ...
    <!-- ✅ Kode Tiket -->
    <td class="px-4 py-2 border" align="center">
        @forelse($order->details as $detail)
         @if($detail->is_used == 0)
            <span style="background-color: yellowgreen; color: black;" class="inline-block bg-gray-200 dark:bg-gray-700 text-xs text-gray-800 dark:text-gray-100 px-2 py-1 rounded mb-1">
                <b style="font-size: 24px; padding: 5px;">{{ $detail->ticket_code }}</b>
            </span>
        @else
            <span style="background-color: red;" class="inline-block bg-gray-200 dark:bg-gray-700 text-xs text-gray-800 dark:text-gray-100 px-2 py-1 rounded mb-1">
                <b style="font-size: 24px;">{{ $detail->ticket_code }}</b>
            </span>
        @endif
        @empty
